...
class DeepLabv3_plus(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=21, os=16, pretrained=False, freeze_bn=False, _print=True):
        ...
        # Atrous Conv, get the feature from res101
        ...
        # four different ASPP to get different receptive fields
    ...
    def forward(self, input):
        ...
        # concat four ASPP module and global average pooling layer
        ...
        # concat low level features and high level features
